      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8">
        <div className="max-w-sm">
          ...
          <p className="mt-5 text-sm leading-relaxed text-deep-muted">
            Diseñamos soluciones que conectan procesos físicos con información útil para decidir mejor.
          </p>
        </div>
        ...
        <nav aria-label="Navegación del sitio" className="text-sm">
          ...
          <ul className="mt-4 space-y-2.5 text-deep-muted">
            <li><Link to="/" className="hover:text-deep-foreground">Inicio</Link></li>
            <li><Link to="/soluciones" className="hover:text-deep-foreground">Soluciones</Link></li>
            <li><Link to="/sectores" className="hover:text-deep-foreground">Sectores</Link></li>
            <li><Link to="/como-trabajamos" className="hover:text-deep-foreground">Cómo trabajamos</Link></li>
            <li><Link to="/empresa" className="hover:text-deep-foreground">Empresa</Link></li>
          </ul>
        </nav>
        ...
        <div className="text-sm">
          ...
          <ul className="mt-4 space-y-2.5 text-deep-muted">
            <li><Link to="/soluciones" hash="monitoreo" className="hover:text-deep-foreground">Monitoreo inteligente</Link></li>
            <li><Link to="/soluciones" hash="automatizacion" className="hover:text-deep-foreground">Automatización de procesos</Link></li>
            <li><Link to="/soluciones" hash="integracion" className="hover:text-deep-foreground">Integración tecnológica</Link></li>
            <li><Link to="/soluciones" hash="analitica" className="hover:text-deep-foreground">Analítica de datos</Link></li>
            <li><Link to="/soluciones" hash="plataformas" className="hover:text-deep-foreground">Plataformas digitales</Link></li>
          </ul>
        </div>
